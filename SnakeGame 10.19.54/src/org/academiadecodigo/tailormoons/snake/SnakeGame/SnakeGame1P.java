...
public class SnakeGame1P implements SnakeGame, KeyHandler {
    ...
    // grid stuff
    private final SnakeGridNormal grid;
    ...
    public SnakeGame1P(SnakeGridNormal grid) {
        this.grid = grid;
    ...
    public void pressed(KeyboardEvent e) {
        if(e.getKey() == KeyboardEvent.KEY_LEFT || e.getKey() == KeyboardEvent.KEY_RIGHT || e.getKey() == KeyboardEvent.KEY_UP || e.getKey() == KeyboardEvent.KEY_DOWN) {
